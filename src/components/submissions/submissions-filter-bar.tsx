...
export function SubmissionsFilterBar({ role, total }: Props) {
  ...
  const hasFilters = skill || status || q || student || sort !== "newest";
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2">
        {/* Search by assignment title (or student name for teacher) */}
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder={role === "TEACHER" ? "Search by assignment or student…" : "Search assignments…"}
            defaultValue={q}
